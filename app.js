  ...
  const TEMPLATE_LIBRARY = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "B-Complex #12 (Thorne)", icon: "💊", color: "#ec4899", category: "Supplements", time: "8:00 AM · with meal 1 (needs fat)", notes: "Take as directed; pair with food if it's easier on your stomach." },
        { name: "5-MTHF 1mg (Thorne)", icon: "💊", color: "#a78bfa", category: "Supplements", time: "8:00 AM · with meal 1 (needs fat)", notes: "Take as directed; pair with food if it's easier on your stomach." },
        { name: "Tongkat Ali (Momentous)", icon: "🌱", color: "#22c55e", category: "Supplements", time: "8:00 AM · with meal 1 (needs fat)", notes: "Take as directed; pair with food if it's easier on your stomach." },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Zinc Picolinate 15mg (Thorne)", icon: "💊", color: "#a855f7", category: "Supplements", time: "6:00 PM · post-workout / meal 3", notes: "Take as directed; pair with food if it's easier on your stomach." },
    ...
    },
    {
      ...
      items: [
        { name: "Magnesium Glycinate (Thorne)", icon: "🌙", color: "#3b82f6", category: "Supplements", time: "7:30 PM · wind-down", notes: "Take as directed; pair with food if it's easier on your stomach." },
        { name: "Ashwagandha (Momentous)", icon: "🌿", color: "#a78bfa", category: "Supplements", time: "7:30 PM · wind-down", notes: "Take as directed; pair with food if it's easier on your stomach." },
      ],
    },
    {
      title: "💊 Supplements — other common",
      items: [
        { name: "Multivitamin",    icon: "💊",  color: "#f59e0b", category: "Supplements", time: "Morning", notes: "Take as directed; pair with food if it's easier on your stomach." },
        { name: "Vitamin C",       icon: "🍊",  color: "#f59e0b", category: "Supplements", time: "Morning", notes: "Take as directed; pair with food if it's easier on your stomach." },
        { name: "Probiotic",       icon: "🦠",  color: "#22c55e", category: "Supplements", time: "Morning", notes: "Take as directed; pair with food if it's easier on your stomach." },
        { name: "Electrolytes",    icon: "🧂",  color: "#38bdf8", category: "Supplements", time: "All day", notes: "Take as directed; pair with food if it's easier on your stomach." },
        { name: "Pre-workout",     icon: "⚡",  color: "#ef4444", category: "Supplements", time: "Afternoon", notes: "Before training" },
        { name: "Whey protein shake", icon: "🥛", color: "#ec4899", category: "Supplements", time: "6:00 PM · post-workout", notes: "Spread intake across meals for best absorption." },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Digestive enzymes", icon: "💊", color: "#3b82f6", category: "Supplements", time: "With meals", notes: "Take as directed; pair with food if it's easier on your stomach." },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Biotin",          icon: "💊",  color: "#3b82f6", category: "Supplements", time: "Morning", notes: "Be gentle; results come from consistency, not intensity." },
